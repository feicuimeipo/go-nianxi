...
var logMiddle = new(OperationLogChanMiddleware)

type OperationLogChanMiddleware struct {
}

// 操作日志channel
var OperationLogChan = make(chan *model.OperationLog, 30)

func NewOperationLogChanMiddleware() *OperationLogChanMiddleware {

	return logMiddle
}

func (o *OperationLogChanMiddleware) OperationLogMiddleware() gin.HandlerFunc {
