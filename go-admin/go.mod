module gitee.com/go-nianxi/go-admin

go 1.20

replace (
	gitee.com/go-nianxi/go-aj-captcha => ../go-aj-captcha
	gitee.com/go-nianxi/go-common => ../go-common
)

require (
	gitee.com/go-nianxi/go-common v0.0.0-20230329162909-8bd0eafa5485
